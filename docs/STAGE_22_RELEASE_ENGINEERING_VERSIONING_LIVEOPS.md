...
**Difficulty rank:** 22/22 — Production
**Suggested prerequisites:** Stages 11-13 and 18-21 as relevant to the project

## Guided lesson: migrate data and gate rollout

**Use case:** Convert a V1 save to V2 and enable a feature for one test user.

**Downloadable code:** [STAGE_22_MIGRATION_AND_FLAG.luau](lessons/STAGE_22_MIGRATION_AND_FLAG.luau)

### Run this before reading the theory

- **Luau CLI:** `luau docs/lessons/STAGE_22_MIGRATION_AND_FLAG.luau`
...
<!-- BEGIN VERIFIED LESSON: STAGE_22_MIGRATION_AND_FLAG.luau -->
```luau
--!strict
...
print("Stage 22 lesson passed")
```
<!-- END VERIFIED LESSON: STAGE_22_MIGRATION_AND_FLAG.luau -->
