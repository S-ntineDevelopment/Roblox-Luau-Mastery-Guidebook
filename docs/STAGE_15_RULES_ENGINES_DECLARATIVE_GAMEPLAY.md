...
**Difficulty rank:** 15/22 — Advanced
**Suggested prerequisites:** Stages 4, 6-7, and 9-11

## Guided lesson: one declarative reward rule

**Use case:** Grant ten coins when a player has at least three wins.

**Downloadable code:** [STAGE_15_SMALL_RULES.luau](lessons/STAGE_15_SMALL_RULES.luau)

### Run this before reading the theory

- **Luau CLI:** `luau docs/lessons/STAGE_15_SMALL_RULES.luau`
...
<!-- BEGIN VERIFIED LESSON: STAGE_15_SMALL_RULES.luau -->
```luau
--!strict
...
```
<!-- END VERIFIED LESSON: STAGE_15_SMALL_RULES.luau -->
