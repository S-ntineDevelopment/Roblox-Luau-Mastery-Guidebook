...
**Difficulty rank:** 13/22 — Advanced
**Suggested prerequisites:** Stages 4, 7, and 9-12

## Guided lesson: idempotent reward

**Use case:** A retried daily reward must not add coins twice.

**Downloadable code:** [STAGE_13_IDEMPOTENT_REWARD.luau](lessons/STAGE_13_IDEMPOTENT_REWARD.luau)

### Run this before reading the theory

- **Luau CLI:** `luau docs/lessons/STAGE_13_IDEMPOTENT_REWARD.luau`
...
<!-- BEGIN VERIFIED LESSON: STAGE_13_IDEMPOTENT_REWARD.luau -->
```luau
--!strict
...
```
<!-- END VERIFIED LESSON: STAGE_13_IDEMPOTENT_REWARD.luau -->
