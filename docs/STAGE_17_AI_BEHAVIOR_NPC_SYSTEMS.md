...
**Difficulty rank:** 17/22 — Expert
**Suggested prerequisites:** Stages 3, 6, 8, and 11; Stage 14 is optional

## Guided lesson: choose one NPC action

**Use case:** An NPC chooses patrol, heal, or attack from current context.

**Downloadable code:** [STAGE_17_NPC_DECISION.luau](lessons/STAGE_17_NPC_DECISION.luau)

### Run this before reading the theory

- **Luau CLI:** `luau docs/lessons/STAGE_17_NPC_DECISION.luau`
...
<!-- BEGIN VERIFIED LESSON: STAGE_17_NPC_DECISION.luau -->
```luau
--!strict
...
```
<!-- END VERIFIED LESSON: STAGE_17_NPC_DECISION.luau -->
