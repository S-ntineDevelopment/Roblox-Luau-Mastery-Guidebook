...
**Difficulty rank:** 21/22 — Production
**Suggested prerequisites:** Stages 8, 11, 14, and 16

## Guided lesson: partition and merge pure work

**Use case:** Split six numbers into three independent jobs and combine their sums.

**Downloadable code:** [STAGE_21_PARTITION_AND_MERGE.luau](lessons/STAGE_21_PARTITION_AND_MERGE.luau)

### Run this before reading the theory

- **Luau CLI:** `luau docs/lessons/STAGE_21_PARTITION_AND_MERGE.luau`
...
<!-- BEGIN VERIFIED LESSON: STAGE_21_PARTITION_AND_MERGE.luau -->
```luau
--!strict
...
print("Stage 21 lesson passed")
```
<!-- END VERIFIED LESSON: STAGE_21_PARTITION_AND_MERGE.luau -->
