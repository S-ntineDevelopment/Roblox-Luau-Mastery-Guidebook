...
**Difficulty rank:** 14/22 — Advanced
**Suggested prerequisites:** Stages 3-6; Stage 11 is recommended

## Guided lesson: the smallest ECS-shaped update

**Use case:** Regenerate every entity that currently has a health component.

**Downloadable code:** [STAGE_14_TINY_ECS.luau](lessons/STAGE_14_TINY_ECS.luau)

### Run this before reading the theory

- **Luau CLI:** `luau docs/lessons/STAGE_14_TINY_ECS.luau`
...
<!-- BEGIN VERIFIED LESSON: STAGE_14_TINY_ECS.luau -->
```luau
--!strict
...
```
<!-- END VERIFIED LESSON: STAGE_14_TINY_ECS.luau -->
