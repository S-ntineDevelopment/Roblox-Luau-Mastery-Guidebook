...
**Downloadable code:** [STAGE_08_ASYNC_OWNERSHIP.luau](lessons/STAGE_08_ASYNC_OWNERSHIP.luau)

### Run this before reading the theory

- **Luau CLI:** `luau docs/lessons/STAGE_08_ASYNC_OWNERSHIP.luau`
...
<!-- BEGIN VERIFIED LESSON: STAGE_08_ASYNC_OWNERSHIP.luau -->
```luau
--!strict
...
```
<!-- END VERIFIED LESSON: STAGE_08_ASYNC_OWNERSHIP.luau -->
