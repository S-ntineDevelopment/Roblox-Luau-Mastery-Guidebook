...
**Difficulty rank:** 11/22 — Intermediate
**Suggested prerequisites:** Stages 4 and 7-10
...
**Downloadable code:** [STAGE_11_DIAGNOSTICS.luau](lessons/STAGE_11_DIAGNOSTICS.luau)

### Run this before reading the theory

- **Luau CLI:** `luau docs/lessons/STAGE_11_DIAGNOSTICS.luau`
...
<!-- BEGIN VERIFIED LESSON: STAGE_11_DIAGNOSTICS.luau -->
```luau
--!strict
...
```
<!-- END VERIFIED LESSON: STAGE_11_DIAGNOSTICS.luau -->
