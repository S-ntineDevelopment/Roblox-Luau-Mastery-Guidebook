...
**Difficulty rank:** 10/22 — Intermediate
**Suggested prerequisites:** Stages 4 and 6-9

## Guided lesson: register one named action

**Use case:** Separately owned features can register actions under stable IDs.

**Downloadable code:** [STAGE_10_ACTION_CONTRACT.luau](lessons/STAGE_10_ACTION_CONTRACT.luau)

### Run this before reading the theory

- **Luau CLI:** `luau docs/lessons/STAGE_10_ACTION_CONTRACT.luau`
...
<!-- BEGIN VERIFIED LESSON: STAGE_10_ACTION_CONTRACT.luau -->
```luau
--!strict
...
```
<!-- END VERIFIED LESSON: STAGE_10_ACTION_CONTRACT.luau -->
