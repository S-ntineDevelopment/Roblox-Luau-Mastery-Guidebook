...
**Difficulty rank:** 12/22 — Intermediate
**Suggested prerequisites:** Stages 4, 7-8, and 10-11
...
**Downloadable code:** [STAGE_12_NETWORK_VALIDATION.luau](lessons/STAGE_12_NETWORK_VALIDATION.luau)

### Run this before reading the theory

- **Luau CLI:** `luau docs/lessons/STAGE_12_NETWORK_VALIDATION.luau`
...
<!-- BEGIN VERIFIED LESSON: STAGE_12_NETWORK_VALIDATION.luau -->
```luau
--!strict
...
```
<!-- END VERIFIED LESSON: STAGE_12_NETWORK_VALIDATION.luau -->
